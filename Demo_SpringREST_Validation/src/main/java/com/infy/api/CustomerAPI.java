...
public class CustomerAPI {
	...
	public ResponseEntity<CustomerDTO> getCustomerDetails(@PathVariable @Min(value =1,message = "Id should be in between 1 and 100")@Max(value =1,message = "Id should be in between 1 and 100") Integer customerId) throws Exception {
